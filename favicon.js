(function() {
    ...
    // --- 1. APP NAME ---
    // Sets the name under the icon on the home screen to "Roam"
    ...
    // Orange circle for browser tabs
    ...
    // --- 3. MOBILE APP ICON (Cream Square, Orange Dot) ---
    const canvas = document.createElement('canvas');
    canvas.width = 180;
    canvas.height = 180;
    const ctx = canvas.getContext('2d');

    // A. Background: Solid Cream
    ctx.fillStyle = '#FDFCF8'; 
    ctx.fillRect(0, 0, 180, 180);

    // B. Center Circle: Brand Orange
